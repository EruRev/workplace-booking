...
import com.irlix.traineeship.workplacebooking.services.OfficeService;
...
public class OfficeController {
    ...
    @Deprecated
    @GetMapping("/deprecated/{office_id}")
    @Operation(summary = "Отображение данных офиса",
            description = "Отображает название и адреса найденного по id офиса")
    public OfficeForOfficeDTO showOfficebyId(@PathVariable UUID office_id) {
        return officeService.showOfficeById(office_id);
    }

    @Deprecated
    @GetMapping("/deprecated/{office_name}")
    @Operation(summary = "Отображение данных офиса",
            description = "Отображает название и адреса найденного по названию офиса")
    public OfficeForOfficeDTO showOfficeByName(@PathVariable String office_name) {
        return officeService.showOfficeByName(office_name);
    }
}
