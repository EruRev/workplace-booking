...
public class WorkplaceController {
    ...
    public List<WorkplaceDTO> searchWorkplaces(@AuthenticationPrincipal UserDetailsImpl currentUser,
        ...
        return workplaceService.searchWorkplaces(currentUser, number);
    }
    ...
    @Deprecated
    @GetMapping("/deprecated/searchById")
    @Operation(summary = "Поиск рабочего места по id",
            description = "Отображает номер, описание со списком техники и статус рабочего места")
    public Optional<WorkplaceEntity> searchWorkplaceById(@PathVariable UUID id) {
        return workplaceService.searchWorkplaceById(id);
    }

    @Deprecated
    @GetMapping("/deprecated/searchByNumber")
    @Operation(summary = "Поиск рабочего места по номеру", description = "Проводит поиск по номеру рабочего места")
    public List<WorkplaceForUserDTO> searchWorkplaceByNumber(@PathVariable Integer number) {
        return workplaceService.searchWorkplaceByNumber(number);
    }
}
