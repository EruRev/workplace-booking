package com.irlix.traineeship.workplacebooking.jwt;

import com.irlix.traineeship.workplacebooking.services.impl.UserDetailsImpl;
import com.irlix.traineeship.workplacebooking.services.impl.UserDetailsServiceImpl;
        ...
        try {
            ...
            if (jwt != null && jwtUtils.validateJwtToken(jwt)) {
                ...
                if (userDetails.isPasswordNeedsChange()) {
                    ...
                    if (!requestURI.equals("/users/changePassword")) {
