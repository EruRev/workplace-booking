...
class UserForUserDTOTest {
    ...
    void testValidUserForUserDTO() {
        UserForUserDTO userDTO =
                new UserForUserDTO("John Doe", "1234567890", "john.doe@example.com");
    ...
    void testInvalidEmail() {
        UserForUserDTO userDTO =
                new UserForUserDTO("John Doe", "1234567890", "invalid-email");
    ...
    void testBlankFullName() {
        UserForUserDTO userDTO = new UserForUserDTO("", "1234567890", "john.doe@example.com");
    ...
    void testNullPhoneNumber() {
        UserForUserDTO userDTO = new UserForUserDTO("John Doe", null, "john.doe@example.com");
    ...
    void testAllFieldsInvalid() {
        UserForUserDTO userDTO = new UserForUserDTO("", null, "invalid-email");
